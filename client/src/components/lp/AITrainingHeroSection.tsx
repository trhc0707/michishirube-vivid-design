...
export default function AITrainingHeroSection() {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-white" data-aos="fade-up">
            ...
            <div className="text-base md:text-lg lg:text-xl mb-6 md:mb-8 space-y-1 md:space-y-2">
              <p>AIツールを導入しても、使いこなせなければ意味がない。</p>
              <p>実践的なハンズオン研修で、</p>
              <p>明日から使えるAIスキルを習得</p>
            </div>
            ...
            <div className="flex gap-3 md:gap-6 mb-6 md:mb-8">
              {[
                { label: "研修満足度", value: "98", unit: "%" },
                { label: "業務活用率", value: "87", unit: "%" },
                { label: "生産性向上", value: "42", unit: "%" },
              ].map((stat, index) => (
                <div
                  key={index}
